...
for fold in range(5):
    ...
    for m in range(n_models):
        ...
        model = GeneInteractionModel(num_features=18).to(device)
    ...
    print('CNN model with no additional features.')
    print('Fold {} Spearman score: {}'.format(fold, R))


'''
Fold 0 Spearman score: 0.7975415267866345
Fold 1 Spearman score: 0.7993508590355898
Fold 2 Spearman score: 0.7920142036309227
Fold 3 Spearman score: 0.8006632634927269
Fold 4 Spearman score: 0.7618406505330982
'''