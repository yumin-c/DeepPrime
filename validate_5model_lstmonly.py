...
from model import LSTMOnly, BalancedMSELoss
...
for fold in range(5):
    ...
    for m in range(n_models):
        ...
        model = LSTMOnly(hidden_size=hidden_size, num_layers=n_layers).to(device)
...
train_file.to_csv('results/lstmonly/final_5cv.csv', index=False)


'''
Fold 0 Spearman correlation: 0.7767768937930104
Fold 0 Pearson correlation: 0.7464592076304046

Fold 1 Spearman correlation: 0.7899596454468804
Fold 1 Pearson correlation: 0.7579742194836504

Fold 2 Spearman correlation: 0.7649132045581561
Fold 2 Pearson correlation: 0.7291149654387081

Fold 3 Spearman correlation: 0.7864936188741403
Fold 3 Pearson correlation: 0.7494117738568715

Fold 4 Spearman correlation: 0.7475184297071672
Fold 4 Pearson correlation: 0.7405213090741036
'''