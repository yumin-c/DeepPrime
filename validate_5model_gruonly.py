...
from model import GRUOnly, BalancedMSELoss
...
for fold in range(5):
    ...
    for m in range(n_models):
        ...
        model = GRUOnly(hidden_size=hidden_size, num_layers=n_layers).to(device)
    ...
    print('GRU model with additional features.')
...
train_file.to_csv('results/gruonly/final_5cv.csv', index=False)


'''
Fold 0 Spearman correlation: 0.7877183104337827
Fold 0 Pearson correlation: 0.7549078831892886

Fold 1 Spearman correlation: 0.79176569467857
Fold 1 Pearson correlation: 0.7589509296456959

Fold 2 Spearman correlation: 0.7809337778451707
Fold 2 Pearson correlation: 0.751302104592603

Fold 3 Spearman correlation: 0.7908977739023438
Fold 3 Pearson correlation: 0.7493966883770893

Fold 4 Spearman correlation: 0.7542181405590176
Fold 4 Pearson correlation: 0.7519635948049902
'''