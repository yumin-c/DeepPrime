...
from transformer import GeneInteractionModel, BalancedMSELoss, GeneFeatureDataset, seq_concat
...
if __name__ == '__main__':
    ...
    for m in range(n_models):
        ...
        torch.save(model.state_dict(),'models/transformers/final_model_{}.pt'.format(m))